...
import br.com.exercicios.ilab.ecommerce.mysql.model.Produto;
...
public interface ProdutoDAO extends CrudRepository<Produto, Integer> {
	...
	@Query("SELECT new "
			+ " br.com.exercicios.ilab.ecommerce.mysql.model.Produto(produto.codigo, produto.nome, produto.descricao, produto.preco, produto.qtdEstoque, produto.linkFoto, departamento.numero, departamento.nome, departamento.andar) "
